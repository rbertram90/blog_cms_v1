...
****************************************************************/
    ...
    require_once SERVER_PATH_BLOGCMS.'/app/controller/blog_content_controller.inc.php';
...
****************************************************************/
    ...
    $global_js_includes = array(
        ...
        RBWEB_CLIENT_FILE_ROOT.'/resources/js/galleria-1.4.2.min',
        RBWEB_CLIENT_FILE_ROOT.'/resources/js/galleria.classic.min'
    );
    // blog_cms Specific JS
    $js_includes = array(
        RBWEB_CLIENT_FILE_ROOT.'/projects/blog_cms/js/addFavourite'
    );
...
****************************************************************/
	...
	require SERVER_PATH_BLOGCMS.'/app/blog_template.php';
?>