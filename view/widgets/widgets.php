<?php
require_once SERVER_PATH_BLOGCMS.'/app/view/widgets/widget_interface.php';
require_once SERVER_PATH_BLOGCMS.'/app/view/widgets/widgets_parentclass.php';
...
function generateWidgets($arrayWidgetConfig, $pobjPosts, $pobjBlogs, $pobjComments, $pobjBlog, $pobjUsers=null) {
  ...
  foreach($arrayWidgetConfig as $category => $widgets) {
	...
	foreach($widgets as $widget):
        ...
        $fileName = SERVER_PATH_BLOGCMS.'/app/view/widgets/'.$key.'.php';
        ...
        if(file_exists($fileName)) {
            ...
            if(ISDEV) $lsWidgetHTML.= showError("Unable to find widget class file - ".$key);
        }
