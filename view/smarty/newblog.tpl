<img src="{$clientroot}/resources/icons/64/add_doc.png" class="settings-icon" /><h1 class="settings-title">Add a blog</h1>

<form action="{$clientroot_blogcms}/submitnewblog" method="post" onsubmit="return checkForm(this);">
