<?php if($DATA['user_is_contributor']): ?>
	<a href="<?=CLIENT_ROOT_BLOGCMS?>" class="action_button">Dashboard</a>
	<a href="<?=CLIENT_ROOT_BLOGCMS?>/posts/<?=$DATA['blog_key']?>/new" class="action_button">Create New Post</a>
	<a href="<?=CLIENT_ROOT_BLOGCMS?>/posts/<?=$DATA['blog_key']?>" class="action_button">Manage Posts</a>
