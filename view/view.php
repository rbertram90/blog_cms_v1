...
class View {
    ...
    public function __construct($models)
    {
        ...
        $this->smarty->template_dir = SERVER_PATH_BLOGCMS.'/app/view/smarty/';
        ...
        $this->addStylesheet(RBWEB_CLIENT_FILE_ROOT.'/resources/css/core');
        $this->addStylesheet(RBWEB_CLIENT_FILE_ROOT.'/resources/css/forms');
        $this->addStylesheet(CLIENT_ROOT_BLOGCMS.'/css/blogs_stylesheet');
        
        // Add default script(s)
        $this->addScript(RBWEB_CLIENT_FILE_ROOT.'/resources/js/jquery-1.8.0.min');
        $this->addScript(RBWEB_CLIENT_FILE_ROOT.'/resources/js/core-functions');
        $this->addScript(RBWEB_CLIENT_FILE_ROOT.'/resources/js/validate');
        $this->addScript(RBWEB_CLIENT_FILE_ROOT.'/resources/js/ajax');
    }
    ...
    **/
    public function render($contenttemplate, $data=false)
    {
        ...
        $this->setVar('serverroot_blogcms', SERVER_PATH_BLOGCMS);
        $this->setVar('clientroot', CLIENT_ROOT);
        $this->setVar('clientroot_blogcms', CLIENT_ROOT_BLOGCMS);
        ...
        if($usesmarty == false)
        {
            ...
            else
            {
                ...
                require SERVER_PATH_BLOGCMS.'/www_root/404.php';
            }
