...
?>
	...
	<form action="<?=$formAction?>" method="post" name="frm_createpost" id="frm_createpost">
        ...
        <button type="button" onclick="rbrtf_showWindow('<?=CLIENT_ROOT_BLOGCMS?>/ajax/image_upload?blogid=<?=$arrayBlog['id']?>')" title="Insert Image"><img src="<?=CLIENT_ROOT_RESOURCES?>/icons/document_image_add_32.png" style="width:15px; height:15px;" /></button>
