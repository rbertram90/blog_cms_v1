...
$filepath = SERVER_PATH_BLOGCMS."/data/blogs/$lsBlogID";
...
<form id="frm_uploadedImage" method="post" name="frm_uploadedImage" onsubmit="closeUploadWindow('<?=CLIENT_ROOT_ABS.'/projects/blog_cms/data/blogs/'.$lsBlogID.'/images/'.$filename;?>'); return false;">
