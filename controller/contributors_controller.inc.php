...
class ContributorController extends GenericBlogCMSController {
	...
	public function route($params) {
		...
		switch($action):
			...
			case "add":
                ...
                $DATA['page_title'] = "Add New Contributor - ".$blog['name'];
				
				// View the add contributor form
				break;
    ...
    **/
	...
	/**
		View the add contributors page
	**/
	...
	**/
	public function actionAdd($blogid) {
		...
		redirect(CLIENT_ROOT_BLOGCMS.'/contributors/'.$blogid);
	}
