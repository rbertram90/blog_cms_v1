...
class BlogContentController {
    ...
    public function __construct($cms_db, $blog_key)
    {
        // Create Models
    ...
    **/
    public function viewHome($DATA, $queryParams)
    {
        ...
        include SERVER_PATH_BLOGCMS.'/app/view/view_posts.php';
    ...
    **/
    public function search($DATA, $queryParams) {
        ...
        // Output results
        require_once SERVER_PATH_BLOGCMS.'/app/view/search_blog_posts.php';
    ...
    **/
    public function generateNavigation() {
        ...
        foreach($pagelist as $postid) {
            ...
            $navigation.= '<a href="'.CLIENT_ROOT_BLOGCMS.'/blogs/'.$arrayPost['blog_id'].'/posts/'.$arrayPost['link'].'">'.$arrayPost['title'].'</a>';
        }
        return $navigation;
    }
    ...
    **/
    public function generateWidgets() {
        ...
        // View
        require SERVER_PATH_BLOGCMS.'/app/view/widgets/widgets.php';
    ...
    **/
    private function getBlogConfig($blogid) {
        ...
        if($this->blogConfig === null) {
            $settings = file_get_contents(SERVER_PATH_BLOGCMS.'/data/blogs/'.$blogid.'/config.json');
    ...
    **/
	...
	{
		$lsSettings = file_get_contents(SERVER_PATH_BLOGCMS.'/data/blogs/'.$this->blog['id'].'/template_config.json');
    ...
    **/
    ...
    public function addComment($DATA, $queryParams)
    {
        ...
        redirect(CLIENT_ROOT_BLOGCMS."/blogs/".$DATA['blog_key']."/posts/".$posturl);
    }
