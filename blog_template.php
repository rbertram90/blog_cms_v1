<?php
    ...
    if(defined("EXTERNAL_DOMAIN") && EXTERNAL_DOMAIN === 1):
        ...
        $blogroot = CLIENT_ROOT_BLOGCMS."/blogs/".$DATA['blog_key'];
    endif;
...
<head>
    ...
    <script>
    Galleria.loadTheme('<?= RBWEB_CLIENT_FILE_ROOT ?>/resources/js/galleria.classic.min.js');
...
<?php
      if(defined("EXTERNAL_DOMAIN") && EXTERNAL_DOMAIN === 1):
          ...
          $css = file_get_contents(SERVER_PATH_BLOGCMS.'/data/blogs/'.$DATA['blog_key'].'/default.css');
...
?>
    <!-- Custom CSS -->
    <style type="text/css"><?=$DATA['custom_css']?></style>
...
<?php include SERVER_ROOT.'/core/view/page-header.php'; ?>
    ...
    <div class="wrapper">
		...
		<?php
			...
			{
				case 1:
					include SERVER_PATH_BLOGCMS.'/app/view/blog_body_singlecolumn.php';
					break;
				case 3:
					if($postcolumn == 1) include SERVER_PATH_BLOGCMS.'/app/view/blog_body_threecolumns_left.php';
					elseif($postcolumn == 2) include SERVER_PATH_BLOGCMS.'/app/view/blog_body_threecolumns_centre.php';
					else include SERVER_PATH_BLOGCMS.'/app/view/blog_body_threecolumns_right.php';
					break;
				case 2:
				default:
					if($postcolumn == 1) include SERVER_PATH_BLOGCMS.'/app/view/blog_body_twocolumns_left.php';
					else include SERVER_PATH_BLOGCMS.'/app/view/blog_body_twocolumns_right.php';
					break;
			}
		?>
